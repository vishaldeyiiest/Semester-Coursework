...
public class Recttransform extends Applet implements ActionListener, MouseListener, MouseMotionListener {
    ...
    void draw(int t0, int t1, int length, int width)
    {
        g1.drawRect(t0, t1, length, width);
        g1.fillRect(t0, t1, length, width);
    }
    @Override
