...
public class labtest2 extends Applet implements ActionListener, MouseListener {
    ...
    Label l3 = new Label("Rotation angle = ");
    ...
    public void draw_ellipse(Graphics2D g) {
        ...
        angle = Double.parseDouble(t3.getText());
    ...
    public void getpoint(Graphics2D g) {
        g.setColor(Color.MAGENTA);
        double x1, y1, x2, y2;
        x1 = rx;
        y1 = 0;
